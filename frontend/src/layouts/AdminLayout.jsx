  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Logout */}
        <div className="px-3 py-4 border-t border-[var(--color-surface-light)]">
          <button
            type="button"
            onClick={signOut}
      ...
      <div className="flex-1 flex flex-col min-h-screen md:ml-0">
        <main className="has-player flex-1 bg-[var(--color-brand)] text-[var(--color-text)] pt-14 md:pt-0 pb-24 px-4 sm:px-6 lg:px-8">
          <Outlet />
        </main>
      </div>
